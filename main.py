...
sim = Simulation(env, rocket, motor, 12, 84, 144, e_log=True, plotter=LivePlotter(update_interval=1000)) # Add plotter=LivePlotter(update_interval=x) to see live plotting
